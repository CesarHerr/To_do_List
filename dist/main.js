...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_crud__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/crud */ \"./modules/crud.js\");\n\n\n\nlet toDoList = new _modules_crud__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\nconsole.log(toDoList)\n\nconst addToDo = document.querySelector('.add');\nconst clearBtn = document.querySelector('.clear');\n\ndocument.addEventListener(\"keyup\", (event) => {\n\n  const activity = document.querySelector(\".add\").value; \n  \n  if (event.code === 'Enter') {\n\n    if (activity !== '') {\n      toDoList.add(activity);\n      toDoList.displayList();\n      addToDo.value = \"\";\n    }\n  }\n});\n\ntoDoList.displayList();\ntoDoList.addRemoveBtnListeners();\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
